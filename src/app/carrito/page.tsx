    ...
    return (
      <section className="py-20 text-center">
        <div className="max-w-md mx-auto px-4">
          ...
          <SectionTitle>Tu carrito está vacío</SectionTitle>
          <DecorativeDivider className="my-6" />
          <p className="text-charcoal/60 leading-relaxed mb-8">
            Explora nuestra tienda y encuentra objetos que inspiran calma.
          </p>
          <a
            href="/tienda"
      ...
      <div className="max-w-3xl mx-auto px-4 sm:px-6">
        <div className="flex items-center justify-between mb-8">
          <div>
            ...
            <p className="text-sm text-charcoal/50 mt-1">{totalItems} producto(s)</p>
          </div>
          <button
            onClick={clearCart}
