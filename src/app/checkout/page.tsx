    ...
    return (
      <section className="py-20 text-center">
        <div className="max-w-md mx-auto px-4">
          ...
          <SectionTitle>¡Pedido confirmado!</SectionTitle>
        ...
        <form ref={formRef} onSubmit={handlePay}>
          <div className="grid grid-cols-1 lg:grid-cols-5 gap-8">
            <div className="lg:col-span-3 space-y-4">
              <h2 className="font-serif text-xl text-sage-dark">Datos de envío</h2>
              <div className="grid grid-cols-2 gap-4">
                <div className="col-span-2">
                  <label className="block text-sm text-charcoal/60 mb-1">Nombre completo *</label>
                ...
                <div className="col-span-2">
                  <label className="block text-sm text-charcoal/60 mb-1">Dirección *</label>
                ...
                <div>
                  <label className="block text-sm text-charcoal/60 mb-1">Ciudad *</label>
                ...
                <div>
                  <label className="block text-sm text-charcoal/60 mb-1">Código postal</label>
                ...
                <div className="col-span-2">
                  <label className="block text-sm text-charcoal/60 mb-1">Teléfono *</label>
              ...
              <h2 className="font-serif text-xl text-sage-dark pt-4">Método de pago</h2>
              <div className="p-4 rounded-lg border border-sage/10 bg-warm-white text-center">
                <p className="text-sm text-charcoal/60">
                  Serás redirigido a Stripe para pagar de forma segura con tarjeta o PayPal.
                </p>
              </div>
            </div>
            ...
            <div className="lg:col-span-2">
              <div className="rounded-xl bg-cream/50 border border-sage/10 p-6 sticky top-24">
                <h3 className="font-serif text-lg text-sage-dark mb-4">Resumen</h3>
